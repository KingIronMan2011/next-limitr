...
export const POST = withRateLimit({
  ...
  getLimitForRequest: async (req: NextRequest) => {
  ...
  webhook: {
    ...
    payload: (req: NextRequest, usage: RateLimitUsage) => ({
  ...
  onLimitReached: async (req: NextRequest, usage: RateLimitUsage) => {
    const userId = req.headers.get("X-User-ID");
    const message =
  ...
  handler: async (usage: RateLimitUsage) => {
